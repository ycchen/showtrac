...
class LittersControllerTest < ActionController::TestCase
  ...
  test "should create litter" do
    assert_difference('Litter.count') do
      post :create, litter: { color_id: @litter.color_id, gender: @litter.gender, pregnancy_id: @litter.pregnancy_id, survival: @litter.survival }
    end
  ...
  test "should update litter" do
    patch :update, id: @litter, litter: { color_id: @litter.color_id, gender: @litter.gender, pregnancy_id: @litter.pregnancy_id, survival: @litter.survival }
    assert_redirected_to litter_path(assigns(:litter))
  end
